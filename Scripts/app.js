...
((core) =>
{
    ...
    function toggleLogin()
    {
      ...
      if(sessionStorage.getItem("user"))
      {
        ...
        // insert contact-list and task-list link to the navigation bar after logged in
        $(`<li class="nav-item">
    ...
    function ActiveLinkCallBack(activeLink)
    {
      switch (activeLink) 
      {
        ...
        case "task-list": return DisplayTaskList;          // add task list call back function
        default:
    ...
    function DisplayTaskList()
    {
        ...
        // don't allow visitors to go here if not log in
        authGuard();
